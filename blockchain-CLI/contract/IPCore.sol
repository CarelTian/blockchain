...
/// v2.0.0  0x92fb20ec1a1558cb80b9d9b7e3b839390f2f6e55
/// now.   0x0CBfD959684FA0829C422E2ECDeA7C80EaBA8141
contract IPcore{
    ...
    function leaseIP(uint id,uint price, uint leaseEndTimestamp) public {
        ...
        require(ip.status != 0,"IP not available for lease");
        require(msg.sender == IPs[id].owner,"Not the owner");
